# Karma generator [![Build Status](https://secure.travis-ci.org/yeoman/generator-flux-sass.svg?branch=master)](http://travis-ci.org/yeoman/generator-flux-sass)
...
Install it globally `npm install -g generator-flux-sass`.
...
this.composeWith('karma:app', {
  ...
  local: require.resolve('generator-flux-sass/generators/app/index.js')
});
